...
$('.block10').on('click', function () {
  ...
  if (points > 0 && points < 21) {
    ...
    $('._2').show();
    $('._2').text('缺乏信心的挑惕者');
    $('._2').text('你擁有近乎強迫症般的追求完美，有些類似於處女座。行事風格屬於謹慎小心型的，在一件事情沒有完全策劃好之前，你是不敢輕易去做的，這也反映了你缺乏自信心的表現，而且對於做事情的過程也很挑剔，不容許自己犯一點點的錯誤。');

  } else if (points > 30 && points < 41) {
    $('._3').show();
    $('._3').text('以牙還牙的自我保護者');
    $('._3').text('你的內心有著很強的控制欲望，有著對於周圍的生活環境一貫性理解的強烈需求，當環境有一點風吹草動，你就會非常的敏感。對待朋友非常的忠誠，而且你更渴望對方也能夠同樣的態度來重視你。你最接受不了的是好朋友在背後議論你，這樣會讓你傷心欲絕，並因此產生報復的心理。');
  } else if (points > 40 && points < 51) {
    $('._4').show();
    $('._4').text('平衡而中庸');

    $('._4').text('你的性格屬於中和性人格，為人有一定的謙遜姿態，但是同時有自己的主見，能夠理解他人，懂得照顧他人的感受，但同時不容許別人侵犯你。你有著很強的自我控制力，你下決心做的事情，一定會成功。很喜歡交朋友，人際關係處理的不錯，常常是朋友圈裡最值得信賴的人物。')
    ...
    $('._6').show();
    $('._6').text('傲慢的孤獨者');
    $('._6').text('你的性格是桀驁的野心家，從骨子裡透出來的傲氣，揚在眉角自信，很像是天蠍座或獅子座。但是你的性格過於孤傲，行事風格以自我為中心，很難考慮到他人的感受，在朋友間常常會讓人不敢靠近。你的內心有很強的支配慾望與控制慾望，你希望能夠得到很大的權利。');
  };
})
